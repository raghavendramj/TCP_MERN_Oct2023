...
fileSystem.readFile("07_MyFile.txt", "utf-8", (err, data) => {
  if (err) {
...
let nonUTFFormattedData = fileSystem.readFileSync("07_MyFile.txt");
...
let uTFFormattedData = fileSystem.readFileSync("07_MyFile.txt", "utf-8");

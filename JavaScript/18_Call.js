...
function objectAndObjectExplained() {
  var person = {
    fullName: function () {
...
function simpleGreet() {
  function greeting(nameOfThePerson) {
    console.log(this.greeting + " " + nameOfThePerson);
  }

  var greet1 = { greeting: "Welcome" };
  greeting.call(greet1, "Raghav");

  var greet2 = { greeting: "Hello" };
  greeting.call(greet2, "Raghav");
}
